...
const AboutContent = () => {
  return (
    <div>
      <p>
        Hi, I'm Arden. I'm a web developer based in Lisbon, Portugal. I create awesome websites/web-apps which are
        enjoyable and fun to use. You can find some of my code on{' '}
        ...
        <a href="https://www.linkedin.com/in/ardenderaaij/" target="_blank" rel="noopener noreferrer">
          LinkedIn
        </a>
        .
      </p>
